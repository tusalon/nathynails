...
const CACHE_NAME = 'nathynails-v56';
const urlsToCache = [
  '/nathynails/',
  '/nathynails/index.html',
  '/nathynails/admin.html',
  '/nathynails/admin-login.html',
  '/nathynails/calendar.html',
  '/nathynails/setup-wizard.html',
  '/nathynails/editar-negocio.html',
  '/nathynails/manifest.json',
  '/nathynails/icons/icon-72x72.png',
  '/nathynails/icons/icon-96x96.png',
  '/nathynails/icons/icon-128x128.png',
  '/nathynails/icons/icon-144x144.png',
  ...
  '/nathynails/utils/push-config.js',
  '/nathynails/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/nathynails/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/nathynails/icons/icon-192x192.png',
    badge: '/nathynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/nathynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/nathynails/admin.html';
  event.waitUntil(
...
console.log('✅ Service Worker configurado para Nathy Nails');
